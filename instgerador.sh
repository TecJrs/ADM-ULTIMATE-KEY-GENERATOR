...
meu_ip
echo -e "\033[1;33mInstalling Files ... "
echo -e "\033[1;36m--------------------------------------------------------------------\033[0m"
cd $HOME
...
echo -ne "\033[1;33mDownloading File \033[1;31m[$arqx] "
wget -O $HOME/$arqx ${REQUEST}/${arqx} > /dev/null 2>&1 && {
echo -e "\033[1;31m- \033[1;32mReceived successfully!"
[[ -e $HOME/$arqx ]] && veryfy_fun $arqx
} || echo -e "\033[1;31m- \033[1;31mFail (not received!)"
done
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/TecJrs/Prueba1/master/Install/trans &> /dev/null
